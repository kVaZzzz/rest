    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateOfBirth', models.DateField(max_length=150, verbose_name='Дата рождения')),
            ],
            options={
                'verbose_name': 'Автор',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.IntegerField(blank=True, choices=[(0, 'Фантастика'), (1, 'Учебник')], verbose_name='Категория')),
