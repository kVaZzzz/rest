...
class Author(models.Model):
    name = models.CharField(max_length=150, verbose_name='Имя', blank=False)
    lastName = models.CharField(max_length=150, verbose_name='Отчество', blank=True)
    middle_name = models.CharField(max_length=150, verbose_name='Фамилия', blank=False)
    dateOfBirth = models.DateField(max_length=150, verbose_name='Дата рождения', blank=False, null=False)
...
class Book(models.Model):
    ...
    class CategoryChoice(models.IntegerChoices):
        FICTION = 0, 'Фантастика'
        NON_FICTION = 1, 'Учебник'
