...
from api.serializers import BookSerializer, AuthorSerializer, CreateBookSerializer
...
class BookDetailAPI(viewsets.ReadOnlyModelViewSet):
...
class AuthorDetailAPI(viewsets.ReadOnlyModelViewSet):
